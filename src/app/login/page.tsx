...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect: explicit redirect param wins, otherwise the middleware will
      // bounce to the role-specific home.
      const target = redirectTo && redirectTo.startsWith("/") ? redirectTo : "/";
      // Use a full page reload so the middleware runs with the new cookies.
