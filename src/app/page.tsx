      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="max-w-3xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <ToolCard
              href="/reports"
              title="Commander un rapport"
              description="Commande de rapports PDF de toiture au freelancer : saisie d'adresse, photos de référence, suivi du statut, téléchargement quand prêt."
              icon={
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <ToolCard
              ...
              description="File ordonnée des installations post-vente. Statut, planification, SMS client J-7/J-2, envoi garantie + facture en 1 clic."
              icon={
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
